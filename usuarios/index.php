<html>
	...
	<body>
        <h1 style="text-align:center;">Ingresar a RestaurantCheck<span class="badge badge-secondary"></span></h1>
		<div class="container">
                ...
                <div class="form-row">
                    <div class="col">
                        <div class="form-group">
							<input type="text" class="form-control" name="usr" required placeholder="Usuario">
						</div>
                    </div>
                    <div class="col">
                       <div class="form-group">
							<input type="password" class="form-control" name="pwd" required placeholder="Contraseña">
						</div>
                    </div>
                </div>
